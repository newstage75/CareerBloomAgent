...
- 🗺️ **目標に向けて何をすればいいかわからない**
  選んだやりたいこと・目標に対して、AIエージェントがロードマップ・必要なスキル・鍛えるべきこと・参考YouTube動画を提案します
...
やりたいこと・将来の目標を1つ選ぶと、AIエージェントが Web 検索（Google Search Grounding）を行いながら **ロードマップ（短期/中期/長期）・必要なスキル・今後鍛えること・参考になるYouTube動画**を提案します。
